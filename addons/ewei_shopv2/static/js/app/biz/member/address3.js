define(['core', 'tpl'], function(core, tpl) {
    ...
    modal.initPost = function(params) {
        ...
        require(reqParams, function() {
            $('#areas3').cityPicker({
                ...
                onClose: function(self) {
                    var datavalue = $('#areas3').attr('data-value');
        ...
        $(document).on('click', '#btn-address', function() {
            wx.openAddress({
                success: function(res) {
                    ...
                    $('#areas3').val(res.provinceName + " " + res.cityName + " " + res.countryName);
                    ...
                    $("#areas3").attr("data-value", province_code + " " + city_code + " " + county_code)
                }
            })
        });
        $(document).on('click', '#btn-submit', function() {
            ...
            var jingwai = /(境外地区)+/.test($('#areas3').val());
            var taiwan = /(台湾)+/.test($('#areas3').val());
            var aomen = /(澳门)+/.test($('#areas3').val());
            var xianggang = /(香港)+/.test($('#areas3').val());
            ...
            window.editAddressData = {
                ...
                datavalue: $('#areas3').attr('data-value'),
