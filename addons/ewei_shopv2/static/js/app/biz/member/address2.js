define(['core', 'tpl'], function(core, tpl) {
    ...
    modal.initPost = function(params) {
        ...
        require(reqParams, function() {
            $('#areas2').cityPicker({
                ...
                onClose: function(self) {
                    var datavalue = $('#areas2').attr('data-value');
        ...
        $(document).on('click', '#btn-address', function() {
            wx.openAddress({
                success: function(res) {
                    ...
                    $('#areas2').val(res.provinceName + " " + res.cityName + " " + res.countryName);
                    ...
                    $("#areas2").attr("data-value", province_code + " " + city_code + " " + county_code)
                }
            })
        });
        $(document).on('click', '#btn-submit', function() {
            ...
            var jingwai = /(境外地区)+/.test($('#areas2').val());
            var taiwan = /(台湾)+/.test($('#areas2').val());
            var aomen = /(澳门)+/.test($('#areas2').val());
            var xianggang = /(香港)+/.test($('#areas2').val());
            ...
            window.editAddressData = {
                ...
                datavalue: $('#areas2').attr('data-value'),
