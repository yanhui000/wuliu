define(['core', 'tpl'], function(core, tpl) {
    ...
    modal.initPost = function(params) {
        ...
        require(reqParams, function() {
            $('#areas4').cityPicker({
                ...
                onClose: function(self) {
                    var datavalue = $('#areas4').attr('data-value');
        ...
        $(document).on('click', '#btn-address', function() {
            wx.openAddress({
                success: function(res) {
                    ...
                    $('#areas4').val(res.provinceName + " " + res.cityName + " " + res.countryName);
                    ...
                    $("#areas4").attr("data-value", province_code + " " + city_code + " " + county_code)
                }
            })
        });
        $(document).on('click', '#btn-submit', function() {
            ...
            var jingwai = /(境外地区)+/.test($('#areas4').val());
            var taiwan = /(台湾)+/.test($('#areas4').val());
            var aomen = /(澳门)+/.test($('#areas4').val());
            var xianggang = /(香港)+/.test($('#areas4').val());
            ...
            window.editAddressData = {
                ...
                datavalue: $('#areas4').attr('data-value'),
