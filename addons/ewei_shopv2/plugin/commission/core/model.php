	...
	class CommissionModel extends PluginModel
	{
		...
		public function checkAgent($openid = '')
		{
			...
			if ($open_redis) {
				...
				$first = 0;
				$member1 = pdo_fetch('select id,openid from ' . tablename('ewei_shop_member') . ' where uniacid=:uniacid', array(':uniacid' => $_W['uniacid']));

				if ($member1) {
					$first = 1;
					$member2 = pdo_fetch('select id,openid from ' . tablename('ewei_shop_member') . ' where uniacid=:uniacid and id<>:fid', array(':uniacid' => $_W['uniacid'], ':fid' => $member1['id']));
			...
			if ($message_type == TM_COMMISSION_AGENT_NEW && empty($usernotice['commission_agent_new'])) {
				if ($tm['is_advanced']) {
					...
					$message = array(
						...
						'keyword2' => array('title' => '业务状态', 'value' => '下级付款通知', 'color' => '#000000'),
						'keyword3' => array('title' => '业务内容', 'value' => '您的下级' . $data['nickname'] . '已经成功付款', 'color' => '#000000'),
						'remark'   => array('value' => "\n感谢您的支持", 'color' => '#000000')
						);
					$toopenid = $openid;
					...
					$msg = array(
						...
						'keyword2' => array('value' => !empty($tm['commission_agent_newtitle']) ? $tm['commission_agent_newtitle'] : '新增下线通知', 'color' => '#73a68d'),
				...
				if ($message_type == TM_COMMISSION_ORDER_PAY && empty($usernotice['commission_order_pay'])) {
					if ($tm['is_advanced']) {
						...
						$message = array(
							'first'    => array('value' => '亲爱的' . $member['nickname'] . '，您的下级' . $data['nickname'] . '已付款', 'color' => '#ff0000'),
							'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
							'keyword2' => array('title' => '业务状态', 'value' => '下级付款通知', 'color' => '#000000'),
							'keyword3' => array('title' => '业务内容', 'value' => '您的下级' . $data['nickname'] . '已经成功付款', 'color' => '#000000'),
							'remark'   => array('value' => "\n感谢您的支持", 'color' => '#000000')
						...
						$msg = array(
							'keyword1' => array('value' => '会员通知', 'color' => '#73a68d'),
							'keyword2' => array('value' => !empty($tm['commission_order_paytitle']) ? $tm['commission_order_paytitle'] : '下线付款通知'),
					...
					if ($message_type == TM_COMMISSION_ORDER_FINISH && empty($usernotice['commission_order_finish'])) {
						if ($tm['is_advanced']) {
							...
							$message = array(
								...
								'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
								'keyword2' => array('title' => '业务状态', 'value' => '下级收货通知', 'color' => '#000000'),
								'keyword3' => array('title' => '业务内容', 'value' => '您的下级' . $data['nickname'] . '已经确认收货', 'color' => '#000000'),
								'remark'   => array('value' => "\n感谢您的支持", 'color' => '#000000')
								);
							$toopenid = $openid;
							...
							$msg = array(
								'keyword1' => array('value' => '会员通知', 'color' => '#73a68d'),
								'keyword2' => array('value' => !empty($tm['commission_order_finishtitle']) ? $tm['commission_order_finishtitle'] : '下线确认收货通知', 'color' => '#73a68d'),
								'keyword3' => array('value' => $message, 'color' => '#73a68d')
								);
						...
						if ($message_type == TM_COMMISSION_APPLY && empty($usernotice['commission_apply'])) {
							if ($tm['is_advanced']) {
								...
								$message = array(
									...
									'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
									'keyword2' => array('title' => '业务状态', 'value' => '提现申请提交通知', 'color' => '#000000'),
									'keyword3' => array('title' => '业务内容', 'value' => '您的佣金提现申请已提交', 'color' => '#000000'),
									'remark'   => array('value' => "\n感谢您的支持", 'color' => '#000000')
									);
								$toopenid = $openid;
								$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
								...
								$msg = array(
									'keyword1' => array('value' => '会员通知', 'color' => '#73a68d'),
									'keyword2' => array('value' => !empty($tm['commission_applytitle']) ? $tm['commission_applytitle'] : '提现申请提交成功', 'color' => '#73a68d'),
									'keyword3' => array('value' => $message, 'color' => '#73a68d')
									);
							...
							if ($message_type == TM_COMMISSION_CHECK && empty($usernotice['commission_check'])) {
								if ($tm['is_advanced']) {
									...
									$message = array(
										...
										'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
										'keyword2' => array('title' => '业务状态', 'value' => '提现申请审核通知', 'color' => '#000000'),
										'keyword3' => array('title' => '业务内容', 'value' => '您的佣金提现申请审核完成', 'color' => '#000000'),
										'remark'   => array('value' => "\n感谢您的支持", 'color' => '#000000')
										);
									$toopenid = $openid;
									$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
									...
									$msg = array(
										'keyword1' => array('value' => '会员通知', 'color' => '#73a68d'),
										'keyword2' => array('value' => !empty($tm['commission_checktitle']) ? $tm['commission_checktitle'] : '提现申请审核处理完成', 'color' => '#73a68d'),
										'keyword3' => array('value' => $message, 'color' => '#73a68d')
										);
								...
								if ($message_type == TM_COMMISSION_PAY && empty($usernotice['commission_pay'])) {
									if ($tm['is_advanced']) {
										...
										$message = array(
											...
											'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
											'keyword2' => array('title' => '业务状态', 'value' => $set['texts']['commission1'] . '打款通知', 'color' => '#000000'),
											'keyword3' => array('title' => '业务内容', 'value' => '您的佣金提现已打款成功', 'color' => '#000000'),
											'remark'   => array('value' => "\n感谢您的支持", 'color' => '#000000')
											);
										$toopenid = $openid;
										$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
										...
										$msg = array(
											'keyword1' => array('value' => '会员通知', 'color' => '#73a68d'),
											'keyword2' => array('value' => !empty($tm['commission_paytitle']) ? $tm['commission_paytitle'] : '佣金打款通知', 'color' => '#73a68d'),
											'keyword3' => array('value' => $message, 'color' => '#73a68d')
											);
									...
									if ($message_type == TM_COMMISSION_UPGRADE && empty($usernotice['commission_upgrade'])) {
										if ($tm['is_advanced']) {
											...
											$message = array(
												...
												'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
												'keyword2' => array('title' => '业务状态', 'value' => $set['texts']['agent'] . '等级升级通知', 'color' => '#000000'),
												'keyword3' => array('title' => '业务内容', 'value' => '您的分销商等级从' . $data['oldlevel']['levelname'] . '升级为' . $data['oldlevel']['levelname'] . '特此通知!', 'color' => '#000000'),
												'remark'   => array('value' => "\n感谢您的支持", 'color' => '#000000')
												);
											$toopenid = $openid;
											$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
											...
											$msg = array(
												'keyword1' => array('value' => '会员通知', 'color' => '#73a68d'),
												'keyword2' => array('value' => !empty($tm['commission_upgradetitle']) ? $tm['commission_upgradetitle'] : '分销等级升级通知', 'color' => '#73a68d'),
												'keyword3' => array('value' => $message, 'color' => '#73a68d')
												);
										...
										if ($message_type == TM_COMMISSION_BECOME && empty($usernotice['commission_become'])) {
											if ($tm['is_advanced']) {
												...
												$message = array(
													...
													'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
													'keyword2' => array('title' => '业务状态', 'value' => '成为' . $set['texts']['agent'] . '通知', 'color' => '#000000'),
													'keyword3' => array('title' => '业务内容', 'value' => '成为分销商通知', 'color' => '#000000'),
													'remark'   => array('value' => "\n感谢您的支持", 'color' => '#000000')
													);
												$toopenid = $openid;
												$datas[] = array('name' => '昵称', 'value' => $data['nickname']);
												...
												$msg = array(
													'keyword1' => array('value' => '会员通知', 'color' => '#73a68d'),
													'keyword2' => array('value' => !empty($tm['commission_becometitle']) ? $tm['commission_becometitle'] : '成为分销商通知', 'color' => '#73a68d'),
													'keyword3' => array('value' => $message, 'color' => '#73a68d')
													);
											...
											if ($message_type == TM_COMMISSION_APPLYMONEY && empty($usernotice['commission_apply'])) {
												if ($tm['is_advanced']) {
													...
													$message = array(
														...
														'keyword1' => array('title' => '商户名称', 'value' => $member['nickname'], 'color' => '#000000'),
														'keyword2' => array('title' => '完成时间', 'value' => $time, 'color' => '#000000'),
														'keyword3' => array('title' => '提现金额', 'value' => $data['commission'], 'color' => '#000000'),
														'keyword4' => array('title' => '提现方式', 'value' => $data['type'], 'color' => '#000000'),
														'remark'   => array('value' => "\n请您注意审核分销商的佣金提现金额，及时打款哦", 'color' => '#000000')
														);
													$toopenid = $tm['openid'];
													$datas[] = array('name' => '昵称', 'value' => $member['nickname']);
													$datas[] = array('name' => '时间', 'value' => $time);
													...
													$msg = array(
														'keyword1' => array('value' => '会员通知', 'color' => '#73a68d'),
														'keyword2' => array('value' => !empty($tm['commission_applymoneytitle']) ? $tm['commission_applymoneytitle'] : '分销商体现通知', 'color' => '#73a68d'),
														'keyword3' => array('value' => $message, 'color' => '#000000')
														);
													return $this->sendNotice($openid, $tm, 'commission_applymoney_advanced', $data, $member, $msg);
												}
											}
										}
									}
