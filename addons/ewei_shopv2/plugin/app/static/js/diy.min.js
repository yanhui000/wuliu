define(['jquery.ui', '../../../../static/js/web/goods_selector.js'], function (ui, gSelector) {
    ...
    modal.initNavs = function () {
        ...
        var navgroup = {
            ...
            2: ['notice', 'goods', 'search', 'fixedsearch', 'copyright', 'video'],
            ...
            4: ['detail_swipe','detail_info','detail_sale','detail_spec','detail_package','detail_shop','detail_buyshow','detail_comment','detail_navbar','pictures','icongroup','audio','goods','copyright']
        };
    ...
    modal.initEditor = function (scroll, activetab) {
        ...
        if ($("#diy-editor .goods-selector").length > 0) {
            ...
            _this.unbind('click').click(function () {
                modal.childid = $(this).closest('.item').data('id');
                gSelector.open('callbackGoods', '', modal.merch);
            });
            /*
        ...
        $("#diy-editor").find('[data-toggle="selectIcon3"]').bind('click', function () {
            ...
            $.ajax(url, {type: "get", dataType: "html", cache: false}).done(function (html) {
                var modal3 = $('<div class="modal fade" id="selectIcon3"></div>');
                $(document.body).append(modal3), modal3.modal('show');
