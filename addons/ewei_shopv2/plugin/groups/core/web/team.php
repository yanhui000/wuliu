...
class Team_EweiShopV2Page extends PluginWebPage
{
	...
	public function cancel_group()
	{
		...
		$orderNum = pdo_fetchcolumn('select COUNT(1) from ' . tablename('ewei_shop_groups_order') . ' where teamid = :teamid and uniacid = :uniacid and status >1 and success = 1 ', array(':teamid' => $teamid, ':uniacid' => $uniacid));
