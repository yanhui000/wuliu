...
class TaskModel extends PluginModel
{
	...
	public function taskPickMessage($openid, $record)
	{
		...
		$message = array(
			...
			'keyword2' => array('title' => '业务状态', 'value' => $record['tasktitle'], 'color' => '#000000'),
			'keyword3' => array('title' => '业务内容', 'value' => $type['type_name'], 'color' => '#000000'),
	...
	public function posterPickMessage($openid, $record)
	{
		...
		$message = array(
			...
			'keyword2' => array('title' => '业务状态', 'value' => $record['tasktitle'], 'color' => '#000000'),
			'keyword3' => array('title' => '业务内容', 'value' => '海报任务', 'color' => '#000000'),
			'keyword1' => array('title' => '业务类型', 'value' => '会员通知', 'color' => '#000000'),
