...
<div class="page-content">
    ...
    <div class="step-region" >
        <ul class="ui-step ui-step-4" >
            ...
            <div class="ui-step-meta" >
                ...
                <?php  } else { ?>
                    <?php  if(2<=$item['status'] || ($item['status']==1 && $item['sendtype'] > 0)) { ?><?php  echo date('Y-m-d',$item['sendtime'])?><br/><?php  echo date('H:i:s',$item['sendtime'])?><?php  } ?>
                <?php  } ?>
            </div>
            </li>
        ...
        <div class="row order-container">
            <div class="order-container-left" style="border-right: 1px solid #efefef">
                <div class="row">
                    <div class="col-md-12">
                        <ul class="">
                            <li class="text"><span class="col-sm">订单编号：</span><span class="text-default"><?php  echo $item['ordersn'];?></span></li>
                            <?php  if(!empty($coupon)) { ?>
                            <li class="text">
                                <span class="col-sm">优惠券：</span>
                                <span class="text-default"><?php  if($coupon['merchid'] == 0) { ?><a href="<?php  echo webUrl('sale/coupon/edit',array('id'=>$coupon['id']))?>" target='_blank'><?php  echo $coupon['couponname'];?></a><?php  } else { ?><?php  echo $coupon['couponname'];?><?php  } ?> &nbsp;&nbsp;<a data-toggle='popover' data-html='true' data-placement='right'
    ...
    "><i class='fa fa-question-circle'></i></a></span>
                            ...
                            <li class="text">
                                ...
                                <span class="text-default">
                                    <a href="<?php  echo webUrl('member/list/detail',array('id'=>$member['id']))?>" target='_blank' class="text-primary"><?php  echo $member['nickname'];?></a> &nbsp;&nbsp;<a data-toggle='popover' data-html='true' data-trigger='hover' data-placement='right'
                                                                                                                                                                                               data-content="<table style='width:100%;'>
                    <tr>
                        <td  style='border:none;text-align:right;' colspan='2'><img src='<?php  echo $member['avatar'];?>' style='width:100px;height:100px;padding:1px;border:1px solid #ccc'  onerror='this.src='../addons/ewei_shopv2/static/images/noface.png''/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td  style='border:none;text-align:right;'>
                        <?php  if(empty($member['nickname'])) { ?>未填写<?php  } else { ?> <?php  echo $member['nickname'];?><?php  } ?>
                    ...
                    <tr>
                        ...
                        <td  style='border:none;text-align:right;'>
                         <?php  if(empty($member['realname'])) { ?>未填写<?php  } else { ?><?php  echo $member['realname'];?><?php  } ?>
                        </td>
                    </tr>
                    <tr>
                        <td  style='border:none;text-align:right;'>手机号：</td>

                        <td  style='border:none;text-align:right;'> <?php  if(empty($member['mobile'])) { ?>未填写<?php  } else { ?><?php  echo $member['mobile'];?><?php  } ?></td>
                    </tr>
                    <tr>
                        <td  style='border:none;text-align:right;'>微信号：</td>
                        <td  style='border:none;text-align:right;'><?php  if(empty($member['weixin'])) { ?>未填写<?php  } else { ?><?php  echo $member['weixin'];?><?php  } ?></td>
                    </tr>
                    </table>
    "><i class='icow icow-help' style="font-size: 13px;color: #2f3434;margin-left: -3px"></i></a>
                            ...
                            <li class="text">
                                ...
                                <span class="text-default"><?php  echo $item['invoicename'];?></span>
                            </li>
                            <?php  } ?>
                            <li class="text">
                                ...
                                <span class="text-default">
                                    ...
                                    <?php  } else if(!empty($item['addressid']) && $item['city_express_state']==0) { ?>
                                        快递
                                    <?php  if(!empty($dispatch['dispatchname'])) { ?>(<?php  echo $dispatch['dispatchname'];?>)<?php  } ?>
                                    <?php  } else if(!empty($item['isvirtualsend']) || !empty($item['virtual'])) { ?>
                                        自动发货<?php  if(!empty($item['isvirtualsend'])) { ?>(虚拟物品)<?php  } else { ?>(虚拟卡密)<?php  } ?>
                                    <?php  } else if($item['dispatchtype']) { ?>
                                        自提
                                    <?php  } else if($item['city_express_state']==1) { ?>
                                        同城配送
                                    <?php  } else { ?>
                                        其他
                                    <?php  } ?>
                            ...
                            <li class="text">
                                ...
                                <span class="text-default"><?php  if($item['verifytype']==0) { ?>
                    ...
                    <tr>
                        ...
                        <td  style='border:none;text-align:right;'><?php  echo date('Y-m-d H:i',$v['verifytime'])?></td>
                            ...
                            <li class="text">
                                ...
                                <span class="text-default">
                                    <?php  echo $user['address'];?>, <?php  echo $user['realname'];?>, <?php  echo $user['mobile'];?> <a class='text-primary op js-clip' data-url="<?php  echo $user['address'];?>, <?php  echo $user['realname'];?>, <?php  echo $user['mobile'];?>">复制</a>
                                </span>
                            </li>
                            ...
                            <li class="text">
                                ...
                                <span class="text-default"><?php  echo $user['storename']['storename'];?></span>
                            </li>
                            <li class="text">
                                <span class="col-sm">自提点：</span>
                                <span class="text-default"><?php  echo html_entity_decode($user['address'])?>,  <?php  echo $user['realname'];?>, <?php  echo $user['mobile'];?></span>
                            </li>

                            <?php  } ?>

                            <?php  if(!empty($item['remark'])) { ?>
                            <li class="text"><span class="col-sm">买家备注：</span><span class="text-default"><?php  echo $item['remark'];?></span></li>
                            <?php  } ?>
                    ...
                    <div class="col-md-12 ops">
                        <?php  if($item['merchid'] == 0) { ?><a class="btn btn-primary" style="margin-left: 10px" data-toggle="ajaxModal" href="<?php  echo webUrl('order/op/changeaddress', array('id' => $item['id']))?>">修改订单收货信息</a><?php  } ?>
                    </div>
                    <?php  } ?>
                    <?php  } ?>
                            ...
                            <li class="text">
                                <span style="display:inline-block;width: 45px;">姓名：</span>
                                            <span class="text-primary" >
                                                <a href="<?php  echo webUrl('member/list/detail',array('id'=>$value['id']))?>" target='_blank' class="text-primary"> <?php  if(empty($value['realname'])) { ?>未填写<?php  } else { ?><?php  echo $value['realname'];?><?php  } ?></a>
                                ...
                                <tr>
                                    <td  style='border:none;text-align:right;'>昵称</td>
                                    <td  style='border:none;text-align:right;'>
                                    <?php  if(empty($value['nickname'])) { ?>未填写<?php  } else { ?> <?php  echo $value['nickname'];?><?php  } ?>
                                ...
                                <tr>
                                    <td  style='border:none;text-align:right;'>姓名：</td>
                                    <td  style='border:none;text-align:right;'>
                                     <?php  if(empty($value['realname'])) { ?>未填写<?php  } else { ?><?php  echo $value['realname'];?><?php  } ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td  style='border:none;text-align:right;'>手机号：</td>

                                    <td  style='border:none;text-align:right;'> <?php  if(empty($value['mobile'])) { ?>未填写<?php  } else { ?><?php  echo $value['mobile'];?><?php  } ?></td>
                                </tr>
                                <tr>
                                    <td  style='border:none;text-align:right;'>微信号：</td>
                                    <td  style='border:none;text-align:right;'><?php  if(empty($value['weixin'])) { ?>未填写<?php  } else { ?><?php  echo $value['weixin'];?><?php  } ?></td>
                                </tr>
                                </table>
                "><i class='icow icow-help' style="font-size: 13px;color: #2f3434"></i></a>
                                            </span>
                            </li>
                            <li class="text"><span style="display:inline-block;width: 50px;">手机号：</span><span class="text-default"><?php  echo $value['mobile'];?></span></li>
                            <li class="text"><span style="display:inline-block;width: 50px;">佣金：</span><span class='text-default'><?php  echo $value['commission'];?></span></li>
                        </ul>
                    </div>
                    <?php  } ?>
                    <?php  } } ?>
            ...
            <div class="packbag-group">
                <?php  if(is_array($order_goods)) { foreach($order_goods as $index => $og) { ?>
                    <div class="packbag-list">
                        <div class="packbag-media"><i class="icow icow-baoguo" style="display: inline-block;vertical-align: middle;font-size: 22px"></i>包裹<?php  echo chr($index+65)?></div>
                        <div class="packbag-inner">
                            <div class="packbag">
                                <div class="packbag-title">
                                    <span style="margin-right: 90px">快递：<?php  if(empty($og['expresscom'])) { ?>其他快递<?php  } else { ?><?php  echo $og['expresscom'];?><?php  } ?></span>
                                    <span style="margin-right: 15px">快递单号：<?php  echo $og['expresssn'];?></span>
                                    <span style="margin-right: 90px"><a class="text-primary op" data-toggle="ajaxModal" href="<?php  echo webUrl('util/express', array('id' => $og['id'],'express'=>$og['express'],'expresssn'=>$og['expresssn']))?>">查看物流</a></span>
                                    <span>发货时间：<?php  echo date('Y-m-d H:i:s', $og['sendtime'])?></span>
                                </div>
                                    ...
                                    <div class="packbag-goods-list">
                                        <div class="packbag-goods">
                                            ...
                                            <div class="packbag-goods-inner">
                                                <p class="title">
                                                    <a target="_blank" href="<?php  echo webUrl('goods/edit', array('id' => $goods['id']))?>"title="查看" style="display: block;line-height: 22px;max-width: 250px;white-space: nowrap;
        overflow: hidden;text-overflow: ellipsis;"><?php  echo $goods['title'];?></a>
                                                </p>
        ...
        overflow: hidden;text-overflow: ellipsis;"><?php  echo $goods['title'];?></a>
                    ...
                    <td style="padding: 10px 20px">
                        ...
                        规格：<?php  if(!empty($goods['optionname'])) { ?><span class="label label-primary" data-container="body" data-toggle="popover" data-placement="right" data-content="<?php  echo $goods['optionname'];?>"><?php  echo $goods['optionname'];?></span><?php  } else { ?>无<?php  } ?>
                        </p>
                        <p>
                            编码：<?php  if(!empty($goods['goodssn'])) { ?><span><?php  echo $goods['goodssn'];?></span><?php  } else { ?>无<?php  } ?>
                        </p>
                        <p>
                            条码：<?php  if(!empty($goods['productsn'])) { ?><span><?php  echo $goods['productsn'];?></span> <?php  } else { ?>无<?php  } ?>
                        </p>
                    </td>
                    ...
                    <td style="text-align: center">
                        <p><?php  echo $goods['total'];?>个</p>
                    </td>
                    <?php  if($item['ispackage']) { ?>
                        <td  style="text-align: center">&yen;<?php  echo number_format($goods['marketprice'],2)?></td>
                    <?php  } else { ?>
                        <td  style="text-align: center">&yen;<?php  echo $goods['orderprice'];?></td>
                        <td  style="text-align: center">
                            &yen;<?php  echo $goods['realprice'];?>
                        </td>
                    <?php  } ?>
        ...
        <h3 class="order-title">记次/时核销记录
            ...
            <small>剩余 <?php  echo $verifygoods_times_total - $verifygoods_times?> / 总数 <span class="text-danger"><?php  echo $verifygoods_times_total;?></span> </small></h3>
          <?php  } ?>
