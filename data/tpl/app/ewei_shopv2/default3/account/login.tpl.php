    ...
    <div class="fui-content" >
        ...
        <?php  if(is_h5app()) { ?>
            ...
            <div class="sns-login">
                ...
                <div class="icons">
                    <?php  if(!empty($sns['wx'])) { ?>
                    <div class="item green btn-sns" data-sns="wx" <?php  if(is_ios()) { ?>style="display: none;"<?php  } ?> id="threeWX"><i class="icon icon-wechat1"></i></div>
                    <?php  } ?>
                    <?php  if(!empty($sns['qq'])) { ?>
        ...
        <script language='javascript'>
            require(['biz/member/account'], function (modal,modal2) {
