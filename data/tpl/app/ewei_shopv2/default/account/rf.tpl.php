...
<div class="fui-page">
    ...
    <div class="fui-header">
        ...
        <div class="title"><?php  if(empty($type)) { ?>立即注册<?php  } else { ?>立即找回<?php  } ?></div>
        ...
        <div class="fui-cell-group fui-cell-group-o account-cell-group">
            ...
            <div class="fui-cell">
                <div class="fui-cell-info ">
                    <div class="btn btn-default btn-default-o block account-btn" id="btnSubmit"><?php  if(empty($type)) { ?>立即注册<?php  } else { ?>立即找回<?php  } ?></div>
                </div>
            </div>
            <div class="fui-cell-title" style="padding:0rem 1rem;;">
                <a href="<?php  echo $set['wap']['loginurl'];?>" class="account-login-link external pull-right">立即登录</a>
                <?php  if(empty($type)) { ?>
                    <a href="<?php  echo $set['wap']['forgeturl'];?>" class="account-login-link  external">忘记密码 </a>
                <?php  } else { ?>
                    <a href="<?php  echo $set['wap']['regurl'];?>" class="account-login-link  external">立即注册 </a>
                <?php  } ?>
            </div>
