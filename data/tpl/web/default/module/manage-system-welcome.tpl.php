...
<div id="js-system-module" ng-controller="installedCtrl" ng-cloak>
	<ul class="we7-page-tab">
		<li class="active"><a href="<?php  echo url('module/manage-system/installed', array('system_welcome' => 1))?>">已安装  </a></li>
		<?php  if(permission_check_account_user('see_module_manage_system_except_installed') && $_W['isfounder']) { ?>
		<li><a href="<?php  echo url('module/manage-system/not_installed', array('system_welcome' => 1))?>">未安装</a></li>
		<li><a href="<?php  echo url('module/manage-system/not_installed', array('system_welcome' => 1, 'status' => 'recycle'))?>">已停用</a></li>
		<?php  } ?>
	</ul>
	<div class="we7-page-search clearfix">
		...
		<form action="" method="get" class="row">
			<div class="form-group we7-margin-bottom  col-sm-4">
				...
				<input type="hidden" name="system_welcome" value="1">
	...
	<form action="" method="get">
		<table class="table we7-table table-hover vertical-middle table-manage table-manage-td">
			...
			<tbody>
			<tr>
				<th colspan="2" class="text-left">系统首页应用</th>
				<th>启用</th>
			...
			<tr ng-repeat="module in module_list">
				...
				<td>
					<div class="switch" ng-class="{'switchOn' : welcome_module == module.name}" ng-click="change_welcome_module(module.name)"></div>
				</td>
...
<ul class="we7-page-tab">
	<li><a href="<?php  echo url('module/manage-system/installed', array('system_welcome' => 1))?>">已安装  </a></li>
	<?php  if(permission_check_account_user('see_module_manage_system_except_installed') && $_W['isfounder']) { ?>
	<li <?php  if($_GPC['status'] == '' && $_GPC['do'] == 'not_installed') { ?>class="active"<?php  } ?>><a href="<?php  echo url('module/manage-system/not_installed', array('system_welcome' => 1))?>">未安装</a></li>
	<li <?php  if($_GPC['status'] == 'recycle' && $_GPC['do'] == 'not_installed') { ?>class="active"<?php  } ?>><a href="<?php  echo url('module/manage-system/not_installed', array('system_welcome' => 1, 'status' => 'recycle'))?>">已停用</a></li>
	<?php  } ?>
</ul>
...
<div class="we7-margin-bottom">
	<button class="btn btn-primary"><a href="<?php  echo url('module/manage-system')?>">返回已安装应用列表</a></button>
</div>
<?php  } ?>
